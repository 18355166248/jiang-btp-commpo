...
export default function GuanliXuanzhong(props: IconProps) {
  ...
  return (
    ...
    >
      <g>
        <defs>
          <clipPath id="b2146__a">
            <rect rx="0" height="24" width="24" />
          </clipPath>
          <clipPath id="b2146__b">
            <rect rx="0" height="24" width="24" />
          </clipPath>
        </defs>
        <g clipPath="url(#b2146__a)" style={{ mixBlendMode: 'passthrough' }}>
          <g clipPath="url(#b2146__b)">
            <path
              fill="#91D5FF"
